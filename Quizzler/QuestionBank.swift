...
class QuestionBank {
    ...
    init() {
        ...
        let item = Question(text: "Sophia was the oldest Golden Girl in real life.", correctAnswer: false)
        
        // Add the Question to the list of questions
        list.append(item)
        
        // skipping one step and just creating the quiz item inside the append function
        list.append(Question(text: "Dorthy hated cheesecake in real life.", correctAnswer: true))
